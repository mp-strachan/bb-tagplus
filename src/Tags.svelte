<script>
    // ==============================================================
    // Original source code by Agustín (https://github.com/agustinl)
    // https://github.com/agustinl/svelte-tags-input
    // From svelte-tags-input@4.0.0
    //
    // Modified by Matthew Strachan (https://github.com/mp-strachan)
    // for use in Budibase Tag+ custom component
    // ==============================================================
    ...
    $: onTagChange = onTagChange || function(){};
